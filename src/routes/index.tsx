...
function TradingHero({
  ...
  return (
    <section
      ...
      className="hero-section relative min-h-[820px] md:min-h-[880px] lg:min-h-[920px] flex flex-col justify-between overflow-hidden bg-[#0b0d10] text-white"
    >
      ...
      <div className="relative z-20 hidden md:flex flex-col items-center justify-center text-center px-4 pt-32 sm:pt-36 md:pt-40 pb-10 sm:pb-14 max-w-5xl mx-auto my-auto select-none w-full">
        <div key={activeSlide} className="animate-hero-fade flex flex-col items-center w-full">
          ...
          <div className="mt-8 sm:mt-9 flex flex-wrap items-center justify-center gap-4 sm:gap-5">
            ...
            >
              <Link to={currentSlide.primaryCta.to} className="flex items-center gap-2">
            ...
            <Button
              asChild
              variant="outline"
              className="rounded-full border-white/20 bg-black/40 px-7 py-3.5 text-sm sm:text-base font-bold text-white hover:bg-white/10 hover:border-[#00D084]/50 backdrop-blur-md cursor-pointer hover:scale-105 transition-all"
            >
            ...
            {slides.map((_, idx) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 cursor-pointer ${
                  idx === activeSlide
                    ? "w-9 bg-[#00D084] shadow-[0_0_10px_#00D084]"
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
            {staticHeroFeatures.map((feat, i) => {
              ...
              return (
                <div
                  key={i}
                  className="group flex items-center justify-center gap-3.5 py-4 sm:py-5 px-3 sm:px-6 transition-all duration-300 hover:bg-[#00D084]/5 cursor-default"
                >
                  <div className="size-9 sm:size-10 rounded-xl bg-[#00D084]/10 border border-[#00D084]/25 text-[#00D084] flex items-center justify-center shrink-0 group-hover:bg-[#00D084] group-hover:text-black group-hover:border-[#00D084] group-hover:shadow-[0_0_18px_rgba(0,208,132,0.35)] transition-all duration-300">
                    <IconComponent className="size-4 sm:size-5" />
                  </div>
                  <div className="min-w-0">
                    <div className="text-sm sm:text-base font-black text-white group-hover:text-[#00D084] transition-colors truncate">
                      {feat.title}
                    </div>
                    <div className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.14em] text-gray-400 group-hover:text-gray-200 transition-colors truncate mt-0.5">
                      {feat.subtitle}
                    </div>
                  </div>
                </div>
  ...
  return (
    <PageShell transparentHeader>
      <div className="relative w-full overflow-hidden bg-[#0b0d10] text-white">
        ...
        <ScrollReveal className="bg-white">
          <section className="w-full bg-white py-24 sm:py-28 text-gray-900 border-b border-gray-200">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 flex flex-col gap-12">
              {/* Top Large Feature Hero Card */}
              <div className="premium-light-card p-8 sm:p-12 md:p-16">
                <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                  <div className="flex flex-col items-start text-left">
                    ...
                    <h2 className="mt-4 text-3xl font-black text-black sm:text-4xl md:text-5xl">
                      {language === "fr"
                        ? "Spreads Bruts Dès 0.0 Pips"
                        : "Raw Spreads From 0.0 Pips"}
                    </h2>
                    <p className="mt-4 text-base font-medium text-gray-700 leading-relaxed">
                      {language === "fr"
                    ...
                    <ul className="mt-8 space-y-4 text-base font-semibold text-gray-800">
                      <li className="flex items-center gap-3">
                        <span className="flex size-6 items-center justify-center rounded-full bg-[#00D084] text-[#021a11] font-extrabold text-xs shadow-sm">
                          ✓
                        </span>
                        <span>
                          {language === "fr"
                    ...
                    <div className="mt-10">
                      <Button
                        asChild
                        className="rounded-full bg-gray-900 px-8 py-3 text-xs font-extrabold text-white hover:bg-black uppercase tracking-wider shadow-md"
                      >
                        <Link to="/pricing">
                  ...
                  <div className="relative flex justify-center lg:justify-end">
                    <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-2xl border border-gray-200 group">
                      <img
                      ...
                      />
                      <div className="absolute top-6 right-6 rounded-2xl bg-white/95 p-4 shadow-2xl border border-gray-100 backdrop-blur-md flex flex-col text-xs font-bold">
                        <div className="flex items-center justify-between gap-4 text-black">
                          <span className="font-extrabold text-sm">EURUSD</span>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div className="premium-light-card flex flex-col justify-between p-8 sm:p-12">
                  <div>
                    <h3 className="text-2xl font-black text-black sm:text-3xl md:text-4xl">
                  ...
                  <div className="mt-10">
                    <Button
                      asChild
                      className="rounded-full bg-gray-200 px-7 py-3 text-xs font-extrabold text-gray-900 hover:bg-gray-300 uppercase tracking-wider"
                    >
        ...
        <ScrollReveal className="bg-[#0b0d10]">
          <section className="relative w-full bg-[#0b0d10] py-24 sm:py-28 text-white border-t border-gray-800/80">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 flex flex-col gap-14">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <h2 className="mt-5 text-4xl font-black tracking-tight text-white sm:text-5xl md:text-6xl leading-tight">
                  {language === "fr"
                    ? "Centres de Données Colocalisés Equinix"
                    : "Equinix Collocated Data Centers"}
                </h2>
                <p className="mt-4 text-base text-gray-300 font-medium leading-relaxed">
                  {language === "fr"
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                {/* Node 1: New York NY4 */}
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 hover:border-[#00D084]/60 transition-all group">
                  <div>
                    ...
                    <h3 className="mt-6 text-3xl font-black text-white group-hover:text-[#00D084] transition-colors">
                      Equinix NY4
                    </h3>
                    <p className="mt-1 text-sm font-bold text-gray-400">New York, USA</p>
                    <p className="mt-4 text-xs text-gray-300 leading-relaxed font-medium">
                      {language === "fr"
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-800/80 flex items-center justify-between text-xs text-gray-400 font-semibold">
                ...
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 hover:border-[#00D084]/60 transition-all group">
                  <div>
                    ...
                    <p className="mt-1 text-sm font-bold text-gray-400">London, United Kingdom</p>
                    <p className="mt-4 text-xs text-gray-300 leading-relaxed font-medium">
                      {language === "fr"
                ...
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 hover:border-[#00D084]/60 transition-all group">
                  <div>
                    ...
                    <p className="mt-1 text-sm font-bold text-gray-400">Tokyo, Japan</p>
                    <p className="mt-4 text-xs text-gray-300 leading-relaxed font-medium">
                      {language === "fr"
        ...
        <ScrollReveal className="bg-[#f4f6f9]">
          <section className="w-full bg-[#f4f6f9] py-24 sm:py-28 text-gray-900 border-t border-gray-200">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 flex flex-col gap-14">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <h2 className="mt-5 text-4xl font-black tracking-tight text-black sm:text-5xl md:text-6xl leading-tight">
                  {language === "fr"
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div className="premium-light-card flex flex-col justify-between p-8">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-black">Smart Order Routing</h3>
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-200 text-xs font-bold text-gray-900 flex items-center justify-between">
                    <span>
                ...
                <div className="premium-light-card flex flex-col justify-between p-8">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-black">Risk Governor & Stop-Out</h3>
                    <p className="mt-4 text-sm font-medium leading-relaxed text-gray-700">
                      {language === "fr"
          ...
          <section className="relative w-full bg-[#0b0d10] py-24 sm:py-28 text-white border-t border-gray-800/80">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 flex flex-col gap-14">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 relative group hover:border-[#00D084]/50 transition-all">
                  <div>
                    <span className="text-4xl font-black text-[#00D084]">01</span>
                    <h3 className="mt-4 text-xl font-black text-white group-hover:text-[#00D084] transition-colors">
                      {language === "fr" ? "Création Espace Client" : "Create Client Account"}
                    </h3>
                    <p className="mt-3 text-xs font-medium text-gray-300 leading-relaxed">
                      {language === "fr"
                ...
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 relative group hover:border-[#00D084]/50 transition-all">
                  <div>
                    <span className="text-4xl font-black text-[#00D084]">02</span>
                    <h3 className="mt-4 text-xl font-black text-white group-hover:text-[#00D084] transition-colors">
                ...
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 relative group hover:border-[#00D084]/50 transition-all">
                  <div>
                    <span className="text-4xl font-black text-[#00D084]">03</span>
                    <h3 className="mt-4 text-xl font-black text-white group-hover:text-[#00D084] transition-colors">
                ...
                <div className="glass-card-dark flex flex-col justify-between p-8 rounded-3xl border border-gray-800 relative group hover:border-[#00D084]/50 transition-all">
                  <div>
                    <span className="text-4xl font-black text-[#00D084]">04</span>
                    <h3 className="mt-4 text-xl font-black text-white group-hover:text-[#00D084] transition-colors">
              ...
              <div className="text-center">
                <Button
                  asChild
                  className="neon-btn rounded-full px-12 py-4 text-sm font-extrabold uppercase tracking-wider text-[#021a11]"
                >
                  <Link to="/robots">
                    {language === "fr"
        ...
        <div className="w-full bg-white border-t border-gray-200 py-14 sm:py-16 px-4 sm:px-6 md:px-8 text-gray-900">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start text-left">
                ...
                <h3 className="mt-4 text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tight text-gray-900 leading-[1.08]">
                  {language === "fr" ? (
                    <>
                ...
                <div className="mt-5 rounded-2xl border border-gray-200/90 bg-gray-50/90 p-4 sm:p-4.5 text-sm sm:text-base text-gray-700 font-medium leading-relaxed shadow-sm flex items-center gap-3.5 w-full max-w-2xl">
                  <div className="size-8 rounded-full bg-[#00D084]/15 border border-[#00D084]/30 flex items-center justify-center shrink-0">
                    <span className="size-2.5 rounded-full bg-[#059669] animate-pulse" />
                  </div>
