...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contactez l'Équipe Nexium Markets — Support & Assistance MT5" },
      {
        property: "og:description",
        content:
          "Formulaire de contact direct et assistance dédiée pour vos robots de trading MetaTrader 5.",
      },
    ],
  }),
...
function ContactPage() {
  ...
  const contactChannels = [
    {
      icon: Mail,
      title: language === "fr" ? "Support Technique MT5" : "MT5 Technical Support",
      description: language === "fr" ? "Configurations de bots, serveurs et VPS." : "Bot setups, servers, and dedicated VPS.",
      contact: "support@nexium-markets.com",
      badge: "< 15 min",
    },
    {
      icon: MessageSquare,
      title: language === "fr" ? "Service Commercial & Licences" : "Sales & Licensing Desk",
      description: language === "fr" ? "Questions sur les plans Pro / Ultimate." : "Inquiries about Pro & Ultimate tiers.",
      contact: "sales@nexium-markets.com",
      badge: "24/7",
    },
    {
      icon: Phone,
      title: language === "fr" ? "Ligne VIP & Institutionnelle" : "VIP & Institutional Line",
